 ...
 * @description Bidirectional mathematical converter between Gregorian UTC dates and the Ethiopian Calendar.
 * Employs astronomical Julian Day Number (JDN) algorithms for 100% deterministic, zero-drift calendar arithmetic.
