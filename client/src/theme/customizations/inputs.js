/**
 * @module theme/customizations/inputs
 * @description Material UI theme customizations for input and button controls.
 */
...
/**
 * Component-level overrides for form inputs, buttons, and selection controls.
